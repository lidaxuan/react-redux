...
import { EdgeData, IBBox, IShapeBase, LabelStyle, NodeConfig, ComboTree, ComboConfig } from '../types';
...
export declare const getComboBBox: (children: ComboTree[], graph: IAbstractGraph) => BBox;
